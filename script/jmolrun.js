      ...
      function runjsmol(accn, selector){
	    Jmol._isAsync = false;
	...
	//	  script: "set zoomlarge false;set antialiasDisplay;load data/1a9n.pdb",
	      script: "set zoomlarge true;set antialiasDisplay;  load ="+accn+".cif; cartoon on; wireframe off; color red; spacefill off; "+selector+"; color white",
